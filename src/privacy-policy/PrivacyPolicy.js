...
const PrivacyPolicy = () => {
  return (
    <>
      ...
      {' '}
      <p>
        Erdi Köse built the Admin LTE app as an Open Source app. This SERVICE is provided by Erdi Köse at no cost and is intended for use as
        is.
      </p>
      {' '}
      <p>
      ...
      {' '}
      <p>If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at erdikose8@gmail.com.</p>
    </>
  );
};
